...
<div class="inner-box">
    <div class="image-box">
        <figure class="image"><img src="{{ asset($blog->post_image) }}" style="width:770px; height:520px;" alt=""></figure>
    ...
    <div class="lower-content">
        ...
        <ul class="post-info clearfix">
            <li class="author-box">
                <figure class="author-thumb"><img src="{{ (!empty($blog->user->photo)) ? url('upload/admin_images/'.$blog->user->photo) : url('upload/no_image.jpg')}}" alt="profile"></figure>
...
<div class="comment-box">
    ...
    <div class="comment replay-comment">
        <figure class="thumb-box">
            <img src="{{ url('upload/img.jpeg') }}" alt="">
        </figure>
        <div class="comment-inner">
            <div class="comment-info clearfix">
                <h5>{{ $rep->subject }}</h5>
...
<div class="widget-content">
    <ul class="category-list clearfix">
    	...
    	@php
    		...
    		$post = App\Models\BlogPost::where('blogcat_id',$category->id)->get();
    	@endphp
        <li><a href="{{ url('blog/cat/list/'.$category->id) }}">{{ ucwords($category->category_name) }}<span>({{ count($post) }})</span></a></li>
  		@endforeach
    </ul>
</div>
</div>
...
<div class="post-inner">
    ...
    <div class="post">
        <figure class="post-thumb"><a href="blog-details.html"><img src="{{ asset($post->post_image) }}" style="width:80px; height:80px;" alt=""></a></figure>
