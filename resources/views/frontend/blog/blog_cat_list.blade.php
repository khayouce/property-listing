...
@section('title')
    {{ $breadcat->category_name }} | ShelterPort
@endsection
        ...
        <div class="inner-box">
            ...
            <div class="lower-content">
                ...
                <ul class="post-info clearfix">
                    <li class="author-box">
                        <figure class="author-thumb"><img src="{{ (!empty($item->user->photo)) ? url('upload/admin_images/'.$item->user->photo) : url('upload/no_image.jpg')}}" alt="profile"></figure>
