...
<h1>{{ $sbread->state_name }} Property</h1>
<ul class="bread-crumb clearfix">
<li><a href="index.html">Home</a></li>
<li>{{ $sbread->state_name }} Property</li>
</ul>
</div>
</div>
</section>
    ...
    <div class="widget-content">
        <div class="select-box">
            <select name="property_status" class="wide">
               <option data-display="All Type" selected="" disabled="">All Status</option>
        ...
        <div class="select-box">
            <select name="state" class="wide">
               <option data-display="Select State" selected="" disabled="">Select State</option>
