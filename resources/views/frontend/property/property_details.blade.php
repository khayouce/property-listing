...
@section('title')
    {{ $property->property_name }} | ShelterPort
@endsection
...
<figure class="author-thumb"><img src="{{ url('upload/img.jpeg') }}" alt=""></figure>
<h6>Admin</h6>
...
<ul class="list clearfix">
   @foreach($property_amenit as $amenit)
    <li>{{ $amenit}}</li>
    @endforeach
...
<h4>Admin</h4>
<ul class="info clearfix">
<li><i class="fas fa-map-marker-alt"></i>otigba</li>
