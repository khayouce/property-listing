                            ...
                            <div class="tabs-content">
                                <div class="tab active-tab" id="tab-1">
                                  ...
                                  <div class="deals-block-one">
                                      <div class="inner-box">
                                          <div class="image-box">
                                              <figure class="image"><img src="{{ asset($item->property_thumbnail) }}" style="width:300px; height:350px;" alt=""></figure>
                                ...
                                <div class="single-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                                   ...
                                   @foreach($featured as $feat)
                                    <div class="feature-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><img src="{{ asset($feat->property_thumbnail) }}" style="width:370px; height:250px;" alt=""></figure>
                                                <div class="batch"><i class="icon-11"></i></div>
                                                <span class="category">Featured</span>
                                            </div>
                                            <div class="lower-content">
                                                <div class="title-text"><h4><a href="{{ url('property/details/'.$item->id.'/'.$item->property_slug) }}">{{ ($feat->property_name) }}</a></h4></div>
                                                <div class="price-box clearfix">
