    ...
    <div class="footer-widget contact-widget">
        ...
        <div class="widget-content">
            <ul class="info-list clearfix">
                ...
                <li><i class="fas fa-envelope"></i><a href="mailto:info@shelterport.com">{{ $setting->email }}</a></li>
            </ul>
        </div>
    </div>
</div>
...
<figure class="footer-logo"><a href="index.html"><img src="{{ asset($setting->logo) }}" alt=""></a></figure>
