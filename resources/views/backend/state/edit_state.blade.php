              ...
              <div class="card-body">
								...
								<form  method="POST" action="{{ route('update.state') }}" class="forms-sample" enctype="multipart/form-data">
									...
									<div class="mb-3">
										...
										<input type="text" name="state_name" class="form-control @error('state_name') is-invalid @enderror" value="{{ $state->state_name }}" >
										@error('state_name')
									...
									<div class="mb-3">
										<label for="exampleInputUsername1" class="form-label"></label>
										 <img id="showImage" class="wd-80 rounded-circle" src="{{ asset($state->state_image) }}" alt="state_image">
									</div>
