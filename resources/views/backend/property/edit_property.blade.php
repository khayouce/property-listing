        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Visit here to get latitude for address</a>
                </div>
            </div><!-- Col -->
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Visit here to get longitude for address</a>
                </div>
            </div><!-- Col -->
        </div><!-- Row -->
                    ...
                    <label class="form-label">Property Amenities</label>
                        <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                                 ...
                                 @foreach($amenities as $amt)
                                    <option value="{{ $amt->amenities_name }}" {{ (in_array($amt->amenities_name,$property_amenities)) ? 'selected' : '' }} >{{ $amt->amenities_name }}</option>
                                    @endforeach
         ...
         <div class="col-sm-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="short_description" id="exampleFormControlTextarea1" rows="3">{{ $property->short_description }}</textarea>
                </div>
            </div><!-- Col -->
        ...
        lowest_price: {
            required : 'Please Enter Property Lowest Price',
        }, 
         max_price: {
            required : 'Please Enter Property Maximum Price',
        }, 
         ptype_id: {
