...
Route::controller(PropertyController::class)->group(function(){
        ...
        Route::get('/property/multiimg/delete/{id}', 'DeletePropertyMultiImage')->name('property.multiimg.delete');
...
Route::controller(AgentPropertyController::class)->group(function(){
         ...
         Route::post('/agent/store/property', 'AgentStoreProperty')->name('agent.store.property');
          ...
          Route::get('/agent/property/multiimg/delete/{id}', 'AgentDeletePropertyMultiImage')->name('agent.property.multiimg.delete');
        Route::post('/agent/store/new/multiimage', 'AgentStoreNewMultiImage')->name('agent.store.new.multiimage');
        Route::post('/agent/update/property/facilities', 'AgentUpdatePropertyFacilities')->name('agent.update.property.facilities');
         Route::get('/agent/property/details/{id}', 'AgentPropertyDetails')->name('agent.property.details');
        ...
        Route::post('/agent/schedule/update', 'AgentScheduleUpdate')->name('agent.schedule.update');
    });
