   ...
   public function AddToCompare(Request $request, $property_id){
        ...
        if(Auth::check()){
            ...
            if (!$exists) {
                ...
                return response()->json(['error' => 'This Property is Already On Your Compare List']);
            }
        }else{
            return response()->json(['error' => 'Login To Compare Property']);
        }
    }
    ...
    public function CompareRemove($id){
        ...
        return response()->json(['success' => 'Compare Property Successfully Removed']);
    }
