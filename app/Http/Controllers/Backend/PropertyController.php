...
class PropertyController extends Controller
{
    ...
    public function PropertyDetails($id){
        ...
        $amenities = Amenities::latest()->get();
        $activeAgent = User::where('status','active')->where('role','agent')->latest()->get();
        return view('backend.property.property_details',compact('property','propertyType','amenities','activeAgent','property_amenities','multiImage','facilities'));
    }
    ...
    public function AdminMessageDetails($id){
        ...
        $usermsg = PropertyMessage::where('id',$id)->get();
